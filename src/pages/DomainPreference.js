...
const QuestionnairePage = () => {
  ...
  return (
    ...
    <div className="questionnaire-container">
      ...
      <label>
          Domain:
          <select value={courseName} onChange={(e) => setTime(e.target.value)}>
            <option value="1-10">Data Analyst</option>
            <option value="10-20">ML</option>
            <option value="more-than-20">Web Dev</option>
            <option value="more-than-20">Full Stack dev</option>
            <option value="more-than-20">DevOps Eng</option>
          </select>
        </label>
